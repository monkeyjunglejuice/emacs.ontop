...
1. With just the =eon= module enabled but nothing else, the experience is exactly that of Emacs ONBOARD -- only built-in Emacs packages are set up and configured, without any 3rd-party packages.
