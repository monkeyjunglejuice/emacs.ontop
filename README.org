...
** Emacs for Julia ★★★★☆
*eon-lang-julia*: The Julia setup is based on the Julia language server, [[https://github.com/gcv/julia-snail][Snail]] and Tree-sitter. The REPL runs within [[Eat][Eat]], the embedded terminal emulator. Enjoy notebook-style literate programming in Org-mode.
